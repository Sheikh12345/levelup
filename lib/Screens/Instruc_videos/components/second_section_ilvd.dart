          ...
          builder: (_, snapshot) {
            if (snapshot.hasData) {
              return ListView.builder(
                  ...
                  itemBuilder: (_, index) {
                    print(
                        "ild ${snapshot.data.data[index].lessonName.toString()}");
                    return snapshot.data.data[index].lessonName
                            .toString()
                            .toLowerCase()
                            .contains("ild")
                        ? InkWell(
                            onTap: () {
                              screenPush(
                                  ...
                                  CourseDetailsIld(
                                    link:
                                        "https://pickleball-levelup.herokuapp.com/read/ild/${snapshot.data.data[index].lessonName}/",
                                    json: snapshot.data.data[index],
                                    trailer:
                                        "https://pickleball-levelup.herokuapp.com/read/ild/${snapshot.data.data[index].lessonName}/${snapshot.data.data[index].data.trailer[0]}",
                                    thumbnail:

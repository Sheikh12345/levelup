...
//
//     final allLids = allLidsFromJson(jsonString);

import 'dart:convert';

AllLids allLidsFromJson(String str) => AllLids.fromJson(json.decode(str));

String allLidsToJson(AllLids data) => json.encode(data.toJson());
...
class AllLids {
  ...
  factory AllLids.fromJson(Map<String, dynamic> json) => AllLids(
